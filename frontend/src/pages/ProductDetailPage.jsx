...
export const ProductDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] pt-24 sm:pt-32 pb-16 sm:pb-24">
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-5 flex flex-col pt-4">
                        <div className="mb-10">
                            <span className="text-[10px] font-black text-primary-600 uppercase tracking-[0.4em] mb-2 sm:mb-4 block">
                                Collection / {product.category}
                            </span>
                            <h1 className="text-3xl sm:text-5xl md:text-6xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-5 sm:mb-8">
                                {product.name}
                            </h1>
                            ...
                            <div className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tighter mb-6 sm:mb-10">
